...
public class MenuController extends MenuBar {
	...
	public MenuController(Frame frame, Presentation pres) {
		...
		menuItem.addActionListener(actionEvent -> this.presentation.exit(0));
		add(fileMenu);
		Menu viewMenu = new Menu(VIEW);
		viewMenu.add(menuItem = mkMenuItem(NEXT));
		menuItem.addActionListener(actionEvent -> this.presentation.nextSlide());
		viewMenu.add(menuItem = mkMenuItem(PREV));
		menuItem.addActionListener(actionEvent -> this.presentation.prevSlide());
		...
		menuItem.addActionListener(actionEvent -> AboutBox.show(this.parent));
